...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	LuaBindingRegisterFunctionDefinitionForType(ManagerLuaBindings, MovableMan) {
		...
		.def("GetMOsInBox", (const std::vector<MovableObject *> * (MovableMan::*)(const Box &) const)&MovableMan::GetMOsInBox, luabind::adopt(luabind::return_value) + luabind::return_stl_iterator)
		.def("GetMOsInBox", (const std::vector<MovableObject *> * (MovableMan::*)(const Box &, int) const)&MovableMan::GetMOsInBox, luabind::adopt(luabind::return_value) + luabind::return_stl_iterator)
		.def("GetMOsInRadius", (const std::vector<MovableObject *> * (MovableMan::*)(const Vector &, float) const)&MovableMan::GetMOsInRadius, luabind::adopt(luabind::return_value) + luabind::return_stl_iterator)
		.def("GetMOsInRadius", (const std::vector<MovableObject *> * (MovableMan::*)(const Vector &, float, int) const)&MovableMan::GetMOsInRadius, luabind::adopt(luabind::return_value) + luabind::return_stl_iterator)
