...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	unsigned long long TimerMan::GetAbsoluteTime() const {
		unsigned long long ticks = SDL_GetPerformanceCounter();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void TimerMan::Update() {
		unsigned long long prevTime = m_RealTimeTicks;
		m_RealTimeTicks = SDL_GetPerformanceCounter() - m_StartTime;
