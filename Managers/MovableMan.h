...
// Return value:    None.
    ...
    void DrawMatter(RenderTarget* renderer, Vector& targetPos);
...
// Return value:    None.
    ...
    void DrawHUD(RenderTarget* renderer, const Vector &targetPos = Vector(), int which = 0, bool playerControlled = false);
