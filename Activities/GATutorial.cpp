...
*/
    ...
    // COMMON SCREENS
    std::vector<SharedTexture> apScreens = ContentFile("Missions.rte/Objects/Tutorial/ScreenStatic.png").GetAsAnimation(3);
    ...
    for (int room = 0; room < ROOMCOUNT; ++room)
    {
		...
		std::vector<SharedTexture> apSigns = signFile.GetAsAnimation(2);
