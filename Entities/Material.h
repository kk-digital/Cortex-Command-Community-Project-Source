...
#pragma region Getters and Setters
		...
		std::shared_ptr<GLTexture> GetTexture() const { return m_TerrainTexture; }
...
#pragma endregion
	...
	protected:
		...
		std::shared_ptr<GLTexture> m_TerrainTexture; //!< The texture of this material, used when building an SLTerrain.
