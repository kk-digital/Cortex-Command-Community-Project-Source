...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	bool SDLGUITexture::Create(int width, int height, bool renderer) {
		...
		m_Height = height;
		if (!renderer) {
			m_Texture = MakeTexture(g_FrameMan.GetRenderer(), width, height, SDL_TEXTUREACCESS_STREAMING);
			Lock();
			m_Texture->clearAll();
		} else {
			m_Texture = MakeTexture(g_FrameMan.GetRenderer(), width, height, SDL_TEXTUREACCESS_TARGET);
		}
